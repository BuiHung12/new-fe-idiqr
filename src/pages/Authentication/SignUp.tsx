...
import {signUpApi} from "../../api/endpoints.ts";
...
const SignUp: React.FC = () => {
  ...
  const handleSignUp = async (e: React.MouseEvent<HTMLInputElement, MouseEvent>) => {
    e.preventDefault();
    try {
      if (password != rePassword) {
        Store.addNotification(notifications.signupError1);
        return
      }
      const payload = { username, password, name }
      const response = await request<AuthState>(signUpApi, 'POST', payload)
      if (response.status === 409) {
        Store.addNotification(notifications.signupError2);
        return
      }
      if (response.status === 201) {
        Store.addNotification(notifications.signupSuccess);
          ...
          <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              ...
              <form>
                <div className="mb-4">
                  ...
                  <div className="relative">
                    <input
                      ...
                      type="text"
                      placeholder={t('signUpPage.hideName')}
                ...
                <div className="mb-4">
                  ...
                  <div className="relative">
                    <input
                      ...
                      type="text"
                      placeholder={t('signUpPage.hideUserName')}
                      className="w-full rounded-lg border border-stroke bg-transparent py-4 pl-6 pr-10 text-black outline-none focus:border-primary focus-visible:shadow-none dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary"
                    />
                ...
                <div className="mb-4">
                  ...
                  <div className="relative">
                    <input
                      ...
                      type="password"
                      placeholder={t('signUpPage.hidePassword')}
                      className="w-full rounded-lg border border-stroke bg-transparent py-4 pl-6 pr-10 text-black outline-none focus:border-primary focus-visible:shadow-none dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary"
                    />
                ...
                <div className="mb-6">
                  <label className="mb-2.5 block font-medium text-black dark:text-white">
                    {t('signUpPage.rePassword')}
                  </label>
                  <div className="relative">
                    <input
                      onChange={(e) => setRePassword(e.target.value)}
                      type="password"
                      placeholder={t('signUpPage.hideRePassword')}
                      className="w-full rounded-lg border border-stroke bg-transparent py-4 pl-6 pr-10 text-black outline-none focus:border-primary focus-visible:shadow-none dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary"
                    />
                ...
                <div className="mt-6 text-center">
                  <p>
                    ...
                    <Link to={PATHS.auth.signIn} className="text-primary">
                      {t('signUpPage.link')}
                    </Link>
                  </p>
                </div>
