...
import {loginApi} from "../../api/endpoints.ts";
import {AuthState, updateAuth} from "../../stores/slices/authSlice.ts";
    ...
    <>
      ...
      <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
        <div className="flex flex-wrap items-center">
              ...
              <form>
                <div className="mb-4">
                  <label className="mb-2.5 block font-medium text-black dark:text-white">
                    {t('signInPage.username')}
                  </label>
                  <div className="relative">
                    <input
                      onChange={(e) => setUsername(e.target.value)}
                      type="text"
                      placeholder={t('signInPage.hideUserName')}
                ...
                <div className="mb-6">
                  ...
                  <div className="relative">
                    <input
                      ...
                      type="password"
                      placeholder={t('signInPage.hidePassword')}
                      className="w-full rounded-lg border border-stroke bg-transparent py-4 pl-6 pr-10 text-black outline-none focus:border-primary focus-visible:shadow-none dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary"
                    />
                ...
                <div className="mt-6 text-center">
                  <p>
                    {t('signInPage.message')}{' '}
                    <Link to={PATHS.auth.signUp} className="text-primary">
                      {t('signInPage.link')}
                    </Link>
                  </p>
                </div>
          ...
          {/*  alertOpen={failAlertOpen}*/}
          {/*  setAlertOpen={setFailAlertOpen}*/}
          {/*/>*/}
        </div>
      </div>
    </>
