...
import {TransferTableToolbar} from "./TransferTableToolbar.tsx";
import Pagination from "./../Pagination.tsx";
import TransferSimpleTable from "./TransferSimpleTable.tsx";
...
interface TransferTableProps<T extends Record<string, unknown>> {
  data: T[],
...
const TransferTable = <T extends Record<string, unknown>>({
                                                       data,
                                                       columnDefs,
                                                       filterColumns,
                                                       setColumnDefs,
